...
class QNetwork(BasePolicy):
    """
    Action-Value (Q-Value) network for DDQN
...
MlpPolicy = DDQNPolicy


class CnnPolicy(DDQNPolicy):
    """
    Policy class for DDQN when using images as input.
...
class MultiInputPolicy(DDQNPolicy):
    """
    Policy class for DDQN when using dict observations as input.
